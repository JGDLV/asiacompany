...
$(document).ready(function () {
  ...
  $(window).on('scroll load', function () {
    $(this).scrollTop() > 600
      ? $('#top, #qr').addClass('active')
      : $('#top, #qr').removeClass('active');
  });
  ...
  $('a[href="#callback"], a[href="#requisites"], a[href="#privacy"], a[href="#rus-map"], a[href="#chn-map"]').magnificPopup({
    type: 'inline',
    // removalDelay: 300,
    // mainClass: 'mfp-fade',
  });
  ...
  $('.portfolio-items').owlCarousel({
    ...
    margin: 22,
    nav: true,
    navText: ["<img src='../img/sprite.svg#left' width='24'>", "<img src='../img/sprite.svg#right' width='24'>"],
    dots: true,
    items: 3,
    responsive: {
      0: {
